...
# Load your data
data_benin = pd.read_csv('benin-malanville.csv', parse_dates=['Timestamp'])
data_togo = pd.read_csv('togo-dapaong_qc.csv', parse_dates=['Timestamp'])
data_sierra_leone = pd.read_csv('sierraleone-bumbuna.csv', parse_dates=['Timestamp'])
